...
import com.alpha.core.validation.VerificationFactory;
...
@Scope("prototype")
public class CaseExecutor implements ICaseExecutor {
    ...
    public void execute() throws CommonException {
        ...
        if (targetMethod != null) {
            for (TestCase testCase : this.testCaseList) {
                ...
                log.info(interfaceInfo.getWsdl().getFacadeClass() + Constants.DOT
