...
public class ValidationExecutor implements ILog {
    ...
    public static void execute(Map<String, VerifyResult> resultMap, Object actualObj, List<VerifyInfo> verifyInfoList) throws ValidationException {
        verifyInfoList.forEach(verifyInfo -> {
            try {
